/* Levi Noell-Baba, September 10, 2023, IST239-W01, Hands-on project 03-03
   
   In Hands-on exercise 03-03 the book is teaching us how to create a for loop that loops through arrays to create a table by referencing the html code.
 */
...
//declaring the htmlCode variable and setting its value to an empty string
let htmlCode = "";
//for loop that includes a counter that starts at 0 and iterates the length of the array by 1
...
//declaring the tableBody variable referencing tbody.
let tableBody = document.getElementsByTagName("tbody")[0];
//declaring the variable tableBody to the value of the htmlCode variable.
